...
<html lang="ko">
  ...
  <body>
	...
	<div align="center">
		...
		<form action="/201345829/idfind2.jsp" method="post">	
		<tr><td><input type="text" name="wname" placeholder="여자이름" /></td></tr><p>
		<tr><td><input type="text" name="mname"  placeholder="남자이름" /></td></tr><p>
		<tr><td><input type="text" name="birth"  placeholder="생년월일" /></td></tr><p>
		<tr><td><button type="submit" style="width:120px; height:25px;">아이디찾기</button></td></tr>
		</form>
		</table>
