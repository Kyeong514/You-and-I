...
<%	FindMemberService findService = new FindMemberService();
	...
	Member mem = findService.findMember_pw(id,wname,mname,date);
	if(mem != null) {
%>
...
<tr>
<td> 회원정보가 틀립니다.</td></tr>
<tr><form action="/201345829/pwfind.jsp" method="post"%>
<td><input type="submit" value="비밀번호찾기"style="width:180px; height:30px;"></td></form>
</tr>
</table>
<%} %>
